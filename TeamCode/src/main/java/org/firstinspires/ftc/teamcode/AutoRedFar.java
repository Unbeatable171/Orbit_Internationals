...
//////
//////    private final Pose startPose = new Pose(85.5, 8.9, Math.toRadians(0));
...
////
////    // ── Timing ────────────────────────────────────────────────────────────────
////    public static double waitDurationSeconds   = 22.0;
////    public static double maxWaitForShotSeconds = 2.5;
////    public static double gateWaitSeconds       = 0.8;
////    public static double rpmTolerance          = 125.0;
////
////    // ── Pulse-based shot parameters (from AutoRedFarNationals) ────────────────
////    public static double transferOpenSeconds   = 0.2;
////    public static double transferClosedSeconds = 0.2;
...
////
////                if (flywheelReady) {
////                    // ── Pulse shot: open transfer and start counting ───────────
////                    transferSubsystem.Open();
////                    transferAction.startfar();
////                    shotTriggered         = true;
...
public class AutoRedFar extends OpMode {
    ...
    public static double transferOpenSeconds   = 0.15;
    public static double transferClosedSeconds = 0.2;
    public static int    shotPulseCountTarget  = 3;
    ...
    public static int    targetRPM2     = 3100;
    public static double hoodAngle2Deg  = 46;

    // ── Poses ─────────────────────────────────────────────────────────────────
    private final Pose startPose           = new Pose(85.5, 8.9, Math.toRadians(0));
    private final Pose shootPose           = new Pose(85.38413685847589, 13.20373250388803, Math.toRadians(60));
    private final Pose humanZone           = new Pose(136.5, 8, Math.toRadians(0));
    private final Pose backPose            = new Pose(110, 8, Math.toRadians(0));
    private final Pose spike3pose          = new Pose(116.5, 32, Math.toRadians(0));
    private final Pose controlSpike3       = new Pose(95.91642498392333, 35);
    private final Pose overflowPick        = new Pose(128.61, 38.12498924965115, Math.toRadians(60));
    private final Pose overflowControlPose = new Pose(122.6064359525804, 5);
...
//                        HeadingInterpolator.facingPoint(redGoalXInches, redGoalYInches)
//                )
                .setLinearHeadingInterpolation(spike3pose.getHeading(),shootPose.getHeading())
                .build();
...
//                        HeadingInterpolator.facingPoint(redGoalXInches, redGoalYInches)
//                )
                .setLinearHeadingInterpolation(overflowPick.getHeading(),shootPose.getHeading())
                .build();
