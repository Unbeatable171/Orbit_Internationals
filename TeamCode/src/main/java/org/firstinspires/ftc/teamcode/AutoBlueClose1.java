...
public class AutoBlueClose1 extends OpMode {
    ...
    // Return from spike 2 control points
    ...
    // Gate (shared for all 3 gate visits)
    ...
    // Gate 1 return control
    private final Pose gateReturnControlPose = new Pose(7.444645799011532, 31.175260681273393);
    // Gate 2 & 3 return control (same control point in file)
//    private final Pose gate2ReturnControlPose = new Pose(7.444645799011532, 31.175260681273393);
//    private final Pose gate3ReturnControlPose = new Pose(7.444645799011532, 31.175260681273393);
    ...
    private void buildPaths() {
        // StartToShoot — BezierLine, heading 90 -> 134.771 deg
        driveStartToShoot = follower.pathBuilder()
                .addPath(new BezierLine(startPose, shootPose))
                .setLinearHeadingInterpolation(startPose.getHeading(), shootPose.getHeading())
                .build();

        // ShootToSpike1 — BezierCurve with 1 control point, heading 134.771 -> 180 deg
        ...
        // Spike1ToShoot — BezierLine, heading 180 -> 134.771 deg
        ...
        // ShootToSpike2 — BezierCurve with 2 control points, heading 134.771 -> 180 deg
        ...
        // Spike2ToShoot — BezierCurve with 2 control points, heading 180 -> 134.771 deg
        ...
        // ShootToGate1 — BezierCurve with 1 control point, heading 134.771 -> 147 deg
        ...
        // Gate1ToShoot — BezierCurve with 1 control point, heading 147 -> 134.771 deg
        ...
        // ShootToGate2 — same geometry as ShootToGate1
        driveShootToGate2 = follower.pathBuilder()
                .addPath(new BezierCurve(shootPose, gateControlPose, gatePose))
                .setLinearHeadingInterpolation(shootPose.getHeading(), gatePose.getHeading())
                .build();

        // Gate2ToShoot — BezierCurve with 1 control point, heading 147 -> 134.771 deg
        driveGate2ToShoot = follower.pathBuilder()
                .addPath(new BezierCurve(gatePose, gateReturnControlPose, shootPose))
                .setLinearHeadingInterpolation(gatePose.getHeading(), shootPose.getHeading())
                .build();

        // ShootToGate3 — same geometry as ShootToGate1/2
        driveShootToGate3 = follower.pathBuilder()
                .addPath(new BezierCurve(shootPose, gateControlPose, gatePose))
                .setLinearHeadingInterpolation(shootPose.getHeading(), gatePose.getHeading())
                .build();

        // Gate3ToShoot — BezierCurve with 1 control point, heading 147 -> 134.771 deg
    ...
    private void runCurrentSequence() {
        if (sequenceState == SequenceState.FINISHED) {
            return;
        }
