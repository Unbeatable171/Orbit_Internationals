...
public class AutoRedFarNationals {
    @Config
    @Autonomous(name = "Auto Red Far might work")
    public static class AutoBlueFarScrimmage extends OpMode {
...
//    }
        ...
        // --- Poses ---
        private final Pose startPose  = new Pose(56,  8.9, Math.toRadians(90)).mirror();
...
//    private final Pose gateReturnControlPose = new Pose(7.444645799011532,  31.175260681273393);
        ...
        // --- State machine ---
        private org.firstinspires.ftc.teamcode.AutoBlueFarScrimmage.SequenceState sequenceState;
        private org.firstinspires.ftc.teamcode.AutoBlueFarScrimmage.SequenceState nextSequenceState;
        ...
        public void init() {
            ...
            buildPaths();
            setSequenceState(org.firstinspires.ftc.teamcode.AutoBlueFarScrimmage.SequenceState.PRELOAD_SHOT);
...
//                .setLinearHeadingInterpolation(gatePose.getHeading(), shootPose.getHeading())
        ...
        private void setSequenceState(org.firstinspires.ftc.teamcode.AutoBlueFarScrimmage.SequenceState newState) {
        ...
        private void configureSequenceIfNeeded() {
            ...
            waitAtEndOfPath   = false;
            currentPath       = null;
            nextSequenceState = org.firstinspires.ftc.teamcode.AutoBlueFarScrimmage.SequenceState.FINISHED;

            switch (sequenceState) {
                case PRELOAD_SHOT:
                    currentPath       = driveStartToShoot;
                    shootDuringPath   = true;
                    nextSequenceState = org.firstinspires.ftc.teamcode.AutoBlueFarScrimmage.SequenceState.TOSpike3;
                    break;
                case ToHumanZone:
                    currentPath       = driveShootToHuman;
                    intakeDuringPath  = true;
                    nextSequenceState = org.firstinspires.ftc.teamcode.AutoBlueFarScrimmage.SequenceState.HUMAN_TO_SHOOT;
                    break;
                //case HumanToBack:
                ...
                case HUMAN_TO_SHOOT:
                    ...
                    intakeDuringPath = true;
                    shootDuringPath = true;
                    nextSequenceState = org.firstinspires.ftc.teamcode.AutoBlueFarScrimmage.SequenceState.ToOverflow;
                    break;
                case TOSpike3:
                    currentPath       = driveShoottoSpike3;
                    intakeDuringPath  = true;
                    nextSequenceState = org.firstinspires.ftc.teamcode.AutoBlueFarScrimmage.SequenceState.RETURN_SHOT_2;
                    break;
                case RETURN_SHOT_2:
                    currentPath       = driveSpike3ToShoot;
                    shootDuringPath   = true;
                    intakeDuringPath = true;
                    nextSequenceState = org.firstinspires.ftc.teamcode.AutoBlueFarScrimmage.SequenceState.ToHumanZone;
                    break;
                case ToOverflow:
                    currentPath       = driveShootToOverflow;
                    intakeDuringPath  = true;
                    waitAtEndOfPath   = true;
                    nextSequenceState = org.firstinspires.ftc.teamcode.AutoBlueFarScrimmage.SequenceState.RETURN_SHOT_3;
                    break;
                case RETURN_SHOT_3:
                    currentPath       = driveOverflowToShoot;
                    shootDuringPath   = true;
                    intakeDuringPath = true;
                    nextSequenceState = org.firstinspires.ftc.teamcode.AutoBlueFarScrimmage.SequenceState.TO_GATE_2;
                    break;
                case TO_GATE_2:
                    currentPath       = driveShoottoOverflow2;
                    intakeDuringPath  = true;
                    waitAtEndOfPath   = true;
                    nextSequenceState = org.firstinspires.ftc.teamcode.AutoBlueFarScrimmage.SequenceState.RETURN_SHOT_4;
                    break;
                case RETURN_SHOT_4:
                    currentPath       = driveOverflowtoShoot2;
                    shootDuringPath   = true;
                    intakeDuringPath = true;
                    nextSequenceState = org.firstinspires.ftc.teamcode.AutoBlueFarScrimmage.SequenceState.TO_GATE_3;
                    break;
                case TO_GATE_3:
                    currentPath       = driveShootToOverflow3;
                    intakeDuringPath  = true;
                    waitAtEndOfPath   = true;
                    nextSequenceState = org.firstinspires.ftc.teamcode.AutoBlueFarScrimmage.SequenceState.RETURN_SHOT_5;
                    break;
                case RETURN_SHOT_5:
                    currentPath       = driveOverflow3ToShoot3;
                    shootDuringPath   = true;
                    intakeDuringPath = true;
                    nextSequenceState = org.firstinspires.ftc.teamcode.AutoBlueFarScrimmage.SequenceState.TO_GATE_4;
                    break;
                case TO_GATE_4:
        ...
        private void runCurrentSequence() {
            if (sequenceState == org.firstinspires.ftc.teamcode.AutoBlueFarScrimmage.SequenceState.FINISHED) return;
