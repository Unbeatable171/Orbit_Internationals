...
//
//    // --- Tunable parameters ---
//    public static double fireDurationSeconds   = 0.9;  //earlier value is 1
...
//    public static int targetRPM1 = 2375;  //2375
//    public static double hoodAngle1Deg = 67;   // degrees, not servo  old = 65
//
//    public static int targetRPM2 = 2500;
//    public static double hoodAngle2Deg = 65;   // degrees, not servo position old = 62
//
...
//
//    private final Pose goalPoseBlue = new Pose(CONSTANTS.blueGoalXInches, CONSTANTS.blueGoalYInches);
//
//    // --- Poses ---
...
//    private final Pose gateReturnControlPose = new Pose(15,  33.65863141524106);
//
