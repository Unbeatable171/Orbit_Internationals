...
//@TeleOp(name = "TeleOp Bang Bang")
public class TeleOpBangBang extends CommandOpMode {
    ...
    private BangBangFlyWheelSubsystem flyWheelSubsystem;
    ...
    public void initialize() {
        ...
        flyWheelSubsystem = new BangBangFlyWheelSubsystem(hardwareMap);
